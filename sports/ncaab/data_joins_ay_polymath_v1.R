...
df_vf <- select(df_vf, -home_Pace,	-home_starters_MP,-home_starters_FG,	-home_starters_FGA,	-home_starters_2P,	-home_starters_2PA,	-home_starters_3P, -home_starters_3PA,	-home_starters_FT,	
                ...
                -home_opp_ORtg,	-home_opp_DRtg,	-home_at_home,	-home_on_the_road,	-home_opp_reserves_Played, -home_team_id_opp, -home_opp_win_perc, -home_opp_opp_win_perc, -home_Days_on_Road, -home_opp_Total_Score)
