...
df_vf <- select(df_vf, -away_Pace,	-away_starters_MP,-away_starters_FG,	-away_starters_FGA,	-away_starters_2P,	-away_starters_2PA,	-away_starters_3P, -away_starters_3PA,	-away_starters_FT,	
                ...
                -away_opp_ORtg,	-away_opp_DRtg,	-away_at_home,	-away_on_the_road,	-away_opp_reserves_Played, -away_team_opp, -away_Pacific)


df_vf <- select(df_vf,-game_id, -datetime, -Location,
...
-away_team_Total_FTr_at_home,-home_Eastern, -home_Central,	-home_Mountain,	-home_Western,
-away_Eastern, -away_Central,	-away_Mountain,	-away_Western)

df_vf$Total <- df_vf$home_Total_Score+df_vf$away_Total_Score

colnames(df_vf)[colnames(df_vf) %in% c("home_team")]<-c("HomeTeam")
colnames(df_vf)[colnames(df_vf) %in% c("home_Total_Score")]<-c("HomePts")
colnames(df_vf)[colnames(df_vf) %in% c("away_team")]<-c("VisitTeam")
